...
public class LayoutPanel extends UIComponentBase { 
	/**
	 * 定义layout组件的起始模板
	 */
	public static final String OPEN_TEMPLATE = "layout/layoutPanel";
	/**
	 * 定义layout组件的结束模板
	 */
	public static final String TEMPLATE = "layout/layoutPanel-close";
	 ...
	 * @return Layout
	 */
	public LayoutPanel(ValueStack stack, HttpServletRequest request,
	...
	public void setTemplate(String template) {
		...
		if (template != null && template.trim().length() > 0) {
			this.template = "layout/" + template + "/layoutPanel-close";
			this.setOpenTemplate("layout/" + template + "/layoutPanel");
		} else {
			template = null;
		}
	}
	...
	protected void evaluateExtraParams() {
		...
		if (region != null) 
			addParameter("region", findString(region));
