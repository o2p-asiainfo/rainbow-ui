...
public class JBarChart extends Element{
	...
	public JBarChart addSeries(Series... s) {
		getValues().addAll(Arrays.asList(s));
		return this;
	}
	
	public JBarChart addGuide(Guide... s) {
		getValues().addAll(Arrays.asList(s));
		return this;
	}
	
	public JBarChart addGraph() {
		return addGraphs(new Graph());
	}

	public JBarChart addGraphs(Graph... s) {
		getValues().addAll(Arrays.asList(s));
		return this;
	}

	public JBarChart addGraphs(List<Graph> values) {
