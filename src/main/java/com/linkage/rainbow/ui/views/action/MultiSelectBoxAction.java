...
/**
 * MultiSelectBoxAction<br>
 * 异步load多选下拉框可选值
 * chenwei
 * @version 1.0
 */
public class MultiSelectBoxAction extends BaseAction{
	private static final long serialVersionUID = 6257678652736650910L;
	private static Log log = LogFactory.getLog(MultiSelectBoxAction.class);

	public String getMulSelectBoxData(){
