...
//                ".  This breaks the JavaBeans specification and can cause unpredicatble results.");
  ...
  private static String dropCase(String name) {
    if (name.startsWith("is")) {
      ...
      throw new ReportException("Error parsing property name '" + name + "'.  Didn't start with 'is', 'get' or 'set'.");
    }
  ...
  public Method getSetter(String propertyName) {
    ...
    if (method == null) {
      throw new ReportException("There is no WRITEABLE property named '" + propertyName + "' in class '" + className + "'");
    }
    return method;
  }
  ...
  public Method getGetter(String propertyName) {
    ...
    if (method == null) {
      throw new ReportException("There is no READABLE property named '" + propertyName + "' in class '" + className + "'");
    }
    return method;
  }
