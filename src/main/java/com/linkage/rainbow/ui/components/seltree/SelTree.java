package com.linkage.rainbow.ui.components.seltree;
...
@StrutsTag(name = "seltree", tldTagClass = "com.linkage.rainbow.ui.views.jsp.ui.seltree.SelTreeTag", description = "下拉树菜单组件类")
public class SelTree extends UIComponentBase{
	 ...
	 * 定义ztree组件的起始模板
	 */
	public static final String OPEN_TEMPLATE = "seltree/simple/seltree";//树标签模版
	/**
	 * 定义ztree组件的结束模板
	 */
	public static final String CLOSE_TEMPLATE = "seltree/simple/seltree-close";//树标签模版

	
	public SelTree(ValueStack stack, HttpServletRequest request,
			HttpServletResponse response) {
		super(stack, request, response);
//		System.out.println("已经进入seltree组件类方法");
	}
	...
	public void setTemplate(String template) {
		if(template != null && template.trim().length()>0) {
			this.template = "seltree/"+template+"/seltree-close";
		    this.setOpenTemplate("seltree/"+template+"/seltree");
	    } else {
	    	template = null;
	    }
	}
