package com.linkage.rainbow.ui.components.switchOf;
...
public class SwitchOf extends ClosingUIBean {
	
	private static final String OPEN_TEMPLATE = "switchOf/switchOf";
	
	private static final String CLOSE_TEMPLATE = "switchOf/switchOf-close";
	...
	public SwitchOf(ValueStack stack, HttpServletRequest request,
	...
	public void setTemplate(String template) {
		if (template != null && template.trim().length() > 0) {
			this.template = "switchOf/" + template + "/switchOf-close";
			this.setOpenTemplate("switchOf/" + template + "/switchOf");
		} else {
			template = null;
		}
	}
