...
${parameters.tagUtil.writeScript("/struts/simple/resource/plugins/jquery.multiselect.filter.js")?string}
...
<script type="text/javascript">
	...
	function ${parameters.id?html} (){
		 ...
		 $("#${parameters.id?html}").multiselect({
	        	...
	        	<#if parameters.label?exists>label:"${parameters.label?html}"</#if>
	        	<#if parameters.filterWidth?exists>,width:"${parameters.filterWidth?html}"</#if>
	        	<#if parameters.placeholder?exists>,placeholder:"${parameters.placeholder?html}"</#if>
	        	<#if parameters.autoReset?exists>,autoReset:${parameters.autoReset?string}</#if>
	        });
