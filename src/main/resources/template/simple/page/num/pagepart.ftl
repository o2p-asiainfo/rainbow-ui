${parameters.tagUtil.writeScript("/struts/simple/page/num/resource/js/script.js")?string}
${parameters.tagUtil.writeScript("/struts/simple/page/num/resource/js/divcreat.js")?string}
${parameters.tagUtil.writeStyle("/struts/simple/page/num/resource/skin/"+parameters.skin+"/css/css.css")?string}
...
<#if stack.getContext().get("${parameters.id}")?exists>
	<#if (stack.getContext().get("${parameters.id?html}").totalRecord==0)>	
		<div id="fenye" class="fenye" align="right">
			<span class="disabled">${parameters.tagUtil.getProperty("rainbow.ui.nextpage")?string}</span>
			<span class="disabled">${parameters.tagUtil.getProperty("rainbow.ui.firstpage")?string}</span>
			<span class="disabled">0</span>
			<span class="disabled">${parameters.tagUtil.getProperty("rainbow.ui.lastpage")?string}</span>
			<span>${parameters.tagUtil.getProperty("rainbow.ui.all")?string}:<b>0</b>${parameters.tagUtil.getProperty("rainbow.ui.record")?string}</span>
		</div>
	<#else>
		...
		<div class="fenye">
			<#if (stack.getContext().get("${parameters.id?html}").currentPage==stack.getContext().get("${parameters.id?html}").totalPage)>
				<span class="disabled">${parameters.tagUtil.getProperty("rainbow.ui.nextpage")?string}</span>
			<#else>
				<a class="next" href="javascript:<#if parameters.showSelect?exists && parameters.showSelect>setexcel${parameters.id?html}();</#if>fn_turnPage('${stack.getContext().get("${parameters.id?html}").currentPage+1}','${parameters.id?html}','${stack.getContext().get("${parameters.id?html}").totalRecord}');">${parameters.tagUtil.getProperty("rainbow.ui.nextpage")?string}</a>
			</#if>
			
			<#if (stack.getContext().get("${parameters.id?html}").currentPage==1)>
				<span class="disabled">${parameters.tagUtil.getProperty("rainbow.ui.firstpage")?string}</span>
			<#else>
				<a class="first" href="javascript:<#if parameters.showSelect?exists && parameters.showSelect>setexcel${parameters.id?html}();</#if>fn_turnPage('1','${parameters.id?html}','${stack.getContext().get("${parameters.id?html}").totalRecord}');">首 页</a>
			</#if>
				
			<#if (stack.getContext().get("${parameters.id?html}").currentPage==stack.getContext().get("${parameters.id?html}").totalPage)>
				<span class="disabled">${parameters.tagUtil.getProperty("rainbow.ui.lastpage")?string}</span>
			<#else>
				<a class="last" href="javascript:<#if parameters.showSelect?exists && parameters.showSelect>setexcel${parameters.id?html}();</#if>fn_turnPage('${stack.getContext().get("${parameters.id?html}").totalPage}','${parameters.id?html}','${stack.getContext().get("${parameters.id?html}").totalRecord}');">末页</a>
			</#if>	
			
			<span>${parameters.tagUtil.getProperty("rainbow.ui.all")?string}:<b>${stack.getContext().get("${parameters.id?html}").totalRecord}</b>${parameters.tagUtil.getProperty("rainbow.ui.record")?string}</span>
